...
export default function Sidebar({
  ...
  return (
    <aside
      className={cn(
        "fixed md:static top-22 md:top-auto bottom-0 left-0 z-50 w-72 border-r border-taupe-300 bg-taupe-100 transition-transform duration-200 ease-out flex flex-col overflow-y-auto md:translate-x-0",
